...
const SignUp = () => {
  ...
  //user create hone k baad redirect krne k liye 
  ...
  const handleuploadPic = async (e) => {
    ...
    const files = e.target.files[0]; //ye hamare image ki info laaayegi upload time pr
    const imagePic = await imageTobase64(files)
    console.log("imagePic" , imagePic)

    setdata ((preve)=>{ //ye image ko store kra di & upload ho gyi create section m
     return{
      ...preve,
      profilePic:imagePic
     } 
  ...
  const handleSubmit = async(e) => {
    // when you submit the form your page will not refresh it
    e.preventDefault();
  ...
  console.log("data saved singup", data);
          ...
          <div className="relative py-3 sm:max-w-xl sm:mx-auto">
            <div className="relative  px-4 py-3 bg-white mx-8 md:mx-0 shadow rounded-3xl sm:p-10">
                   ...
                   <div className=' w-24 h-24 mx-auto relative overflow-hidden rounded-full'>
                        <div>
                          <img  src={data.profilePic || "images/logoicon.gif"} alt="" /> 
                        </div>
                        <form >
                          <label>
                              <div className='test bg-opacity-50  bg-slate-200 text-xs text-center px-1 py-1 pb-6 h-[35px]  bottom-0 cursor-pointer absolute  w-full'>
                                    upload photo
                              </div>
                  ...
                  <label
                    ...
                    <div className="flex relative">
                      <input
                        ...
                        className="border rounded-lg px-3 py-2 mt-1 mb-3 w-full h-full"
                        required
                        name="password"
                        onChange={handleOnchange}
                        value={data.password}
