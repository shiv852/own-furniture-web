...
import AllContactShow from "./AllContactShow";
...
const AllContactbtn = () => {
  ...
  return (
    <>
      <div className=" flex flex-row  py-7 my-2 justify-center md:justify-normal">
        <div className="contactme mx-1 ">
          <button className="relative inline-flex h-12 active:scale-95 transistion overflow-hidden rounded-lg p-[1px] focus:outline-none">
            ...
            <span className="inline-flex h-full w-full cursor-pointer items-center justify-center rounded-lg bg-slate-950 px-7 text-sm font-medium text-white backdrop-blur-3xl gap-2 undefined">
              <Link to="tel:9928652881" className="no-underline text-white">
                Contact me
              </Link>
              <svg
                stroke="currentColor"
        ...
        <div className="share">
          ...
          {showmodel && 
                <AllContactShow onClose={() => setshowmodel(false)} />
          }
        </div>
      </div>
    </>
