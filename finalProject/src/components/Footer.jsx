...
const Footer = () => {
  ...
  return (
    <div
      className="footer mx-2 my-2 rounded-md md:flex  md:justify-center  mt-10  md:flex-row  "
      style={{ background: "#16384c" }}
    >

      <div className="box1 w-[100%] h-[100%] ">
     

           <div className="flex justify-center  align-middle items-center">

           
        <div className="btn  absolute    z-10  ">
      ...
      <div className="secondinner ">
        <div className="secondbox md:flex   ">
          <div
            //  bg-pink-600
            className="box2  list-none py-4 pl-[10px] text-white text-md md:px-10  "
          ...
          >
            ...
            <p>
              <i className="fa fa-phone" aria-hidden="true"></i> +91 9928652881
            </p>
            <p>
            ...
            <p>
              ...
              kumarsainiMahesh59@gmail.com
            </p>
          </div>
          {/* bg-purple-600 */}
          <div
            className="box2   list-none py-4 pl-[20px] text-white text-md md:px-20 "
            style={{ fontFamily: " sans-serif" }}
          >
            <h4>
              <b>TOP CATEGORIES</b>
            ...
            <p>
              <i className="fa fa-chevron-right" aria-hidden="true"></i>Bedroom
            </p>
            <p>
              <i className="fa fa-chevron-right" aria-hidden="true"></i>Sofas
            </p>
            <p>
              <i className="fa fa-chevron-right" aria-hidden="true"></i>dining
              Room
            </p>
            <p>
          ...
          {/* bg-pink-500  */}
          <div
            className="box2  list-none py-4 pl-[10px] text-white text-md md:px-20  "
            style={{ fontFamily: " sans-serif" }}
          >
            <h3>furniture</h3>
            <li>bedroom </li>
        ...
        <div className="thirdbox flex-col ">
          <div className="thirdbox md:flex">
            {/* bg-purple-400 */}
            <div id="socialbtn" className=" md:px-8  ">
              <div className="flex items-center py-4 justify-center gap-4  mx-auto">
              ...
              <div className=" pl-[10px] text-white text-center ">
                <p style={{ fontWeight: "300px", fontSize: "12px" }}>
                  term & condition privacy policy security center Accessibility
                </p>
              </div>
            </div>
            ...
            <div
              id="inputbtn"
              className="  list-none py-4 pl-[10px] text-white text-md md:px-20"
            >
              <p style={{ fontWeight: "600px" }}>
                Receive articles, tips, and offers from furniture
              </p>
              <input type="input" />
              <p style={{ fontWeight: "600px", fontSize: "12px" }}>
                we care about protecting your data <br />
                Read more in our{" "}
                <span className="underline">Privacy Policy</span>
              </p>
              <p>
                ©2024 jaipur furniture. All Rights Reserved. jaipur furniture
                are trademarks may not be used without permission.
              </p>
            </div>
          </div>
        </div>
